...
namespace MinecraftLibrary
{
    ...
    public static class ChatParser
    {
        ...
        private static void InitRules()
        {
            ...
            string Language_File = "lang" + ('/') + "" + ".lang";
            ...
            if (!System.IO.File.Exists(Language_File))
            {
                ...
                try
                {
                    string assets_index = DownloadString("");
                    string[] tmp = assets_index.Split(new string[] { "minecraft/lang/" + "" + ".json" }, StringSplitOptions.None);
                    ...
                    string translation_file_location = "" + '/' + hash.Substring(0, 2) + '/' + hash;
